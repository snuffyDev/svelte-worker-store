...
<p class="text-sm mb-0">
	This demo executes the Julia Set fractal algorithm 4 times, creating a total
	of 4 different images that will be displayed below on the left.
</p>
<p class="text-sm mb-0">
...
<div
	class="grid grid-rows-2 gap-8 p-2 sm:grid-cols-2 sm:gap-16 mt-8 border border-solid border-surface-400 border-opacity-30 rounded-xl sm:p-8"
>
	<div class="flex flex-col justify-start">
		...
		<div class="gallery grid grid-rows-2 grid-cols-2">
			{#each Array(4) as _, i}
				<img width="480" height="320" bind:this={image[i]} />
			{/each}
		</div>
	</div>
